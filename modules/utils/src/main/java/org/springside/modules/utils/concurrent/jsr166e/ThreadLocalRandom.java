 ...
 * 从 Doug Lea的CVS移植.
 * 
 * 选择1.18版, 比JDK7实现更好的初始化seed，但未引入JDK8 Streaming
 * 
 * http://gee.cs.oswego.edu/cgi-bin/viewcvs.cgi/jsr166/src/main/java/util/concurrent/ThreadLocalRandom.java?revision=1.18&view=markup
 * 
