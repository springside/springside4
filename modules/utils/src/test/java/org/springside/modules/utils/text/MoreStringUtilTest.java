...
public class MoreStringUtilTest {
	...
	public void split() {
		...
		assertThat(result).hasSize(4).containsExactly("192", "168", "0", "1");

		result = MoreStringUtil.split("192.168..1", '.', 4);
		assertThat(result).hasSize(3).containsExactly("192", "168", "1");

		result = MoreStringUtil.split("192.168.0.", '.', 4);
		assertThat(result).hasSize(3).containsExactly("192", "168", "0");
	}
